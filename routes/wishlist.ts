        ...
        wishes: [
            {
                ...
                img_url:
                    "https://i.auto-bild.de/ir_img/2/7/0/5/0/3/7/2-APPLE-CAR-2-iMac-G3-92c755da09344228.jpg?impolicy=leadteaser",
            },
            {
                id: 2,
                name: "Bike",
                ...
                img_url:
                    "https://media.wired.com/photos/61afb902c2f5f4d2aaf1c249/master/w_1600,c_limit/Gear-Jackbrabbit-Bike-Lifestyle-1.jpg",
            },
        ],
    },
    {
        ...
        wishes: [
            {
                ...
                img_url:
                    "https://www.techspot.com/images2/news/bigimage/2017/03/2017-03-01-image-7.jpg",
            },
        ],
    },
];
...
router.get("/children/:id/wishes", (req, res) => {
    ...
    const child: IChild = childrenArray.find((child: IChild) => {
        return child.id === id;
    });
...
router.post("/children", (req: any, res: any) => {
...
router.post("/children/:id/wishes", (req: any, res: any) => {
    const id = +req.params.id;
    const newWish: IWish = req.body;
